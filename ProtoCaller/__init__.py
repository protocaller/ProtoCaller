...
CHARMMPROTEINFFS = ["charmm36m", "charmm36"]
CHARMMLIGANDFFS = ["cgenff"]
CHARMMWATERFFS = []
CHARMFFS = CHARMMPROTEINFFS + CHARMMLIGANDFFS + CHARMMWATERFFS
CHARMMDEFAULTPROTEINFF = "charmm36m"
CHARMMDEFAULTLIGANDFF = "cgenff"
CHARMMDEFAULTWATERFF = "tip3p"

PROTEINFFS = AMBERPROTEINFFS + CHARMMPROTEINFFS
LIGANDFFS = AMBERLIGANDFFS + CHARMMLIGANDFFS
WATERFFS = AMBERWATERFFS + CHARMMWATERFFS
